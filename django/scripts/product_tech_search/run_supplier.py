...
def search_supplier(doc_id):
	...
	try:
		...
		args = [doc_id]
		mysql_cursor.callproc( 'scin_db.pub_supplier_exists', args )

		query = ("SELECT count(1) as count FROM scin_db.pub_supplier_result WHERE doc_id = %s ")
