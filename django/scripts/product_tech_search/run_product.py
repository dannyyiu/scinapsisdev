...
def search_product(doc_id):
	...
	try:
		...
		args = [doc_id]
		mysql_cursor.callproc( 'scin_db.pub_product_exists', args )

		query = ("SELECT count(1) as count FROM scin_db.pub_product_result WHERE doc_id = %s ")
